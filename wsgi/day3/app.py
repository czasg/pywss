...
if __name__ == '__main__':
    app = Pywss()
    app.get("/text", lambda ctx: ctx.write("Hello, Pywss!"))
    app.get("/json", lambda ctx: ctx.write({"Hello": "Pywss"}))
    app.get("/headers", lambda ctx: ctx.write(ctx.headers()))
    app.get("/cookies", lambda ctx: ctx.write(ctx.cookies()))
    app.run()
