...
```python title="服务端" showLineNumbers {6,7}
import pywss
...
### CORS
```python title="https://github.com/czasg/pywss/blob/master/pywss/handler/cors.py" showLineNumbers
import pywss
...
### JWT
```python title="https://github.com/czasg/pywss/blob/master/pywss/handler/jwt.py" showLineNumbers
import json
import time
import pywss
import base64
