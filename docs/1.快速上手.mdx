...
**`ctx.next`** 本质是一个简单的链式调用功能。

其源代码也是非常的简洁，其核心逻辑仅由5行代码实现：
...
在此处不再拓展，具体实现可以参考[源码](https://github.com/czasg/pywss)。


### 使用方法

基于 **`ctx.next`** 链式调用的特性，一般可以用于实现**中间件拓展**。
